#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Yeni RentFlow blog yazılarını Bluesky'a postlar (başlık + açıklama + #etiket + görsel link kartı).
...
TAGS = "#landlord #realestate #rental #property #rentflow"
...
def main():
    ...
    for url in urls:
        ...
        cta = f"📲 Get RentFlow free 👇 {STORE_LINK}"
        text = f"🏠 {title}\n\n{desc[:105]}\n{cta}\n\n{TAGS}"[:295]
        thumb = None
        if ogimg:
            try:
